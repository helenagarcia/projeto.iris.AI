...
# Load a sample picture and learn how to recognize it (directory Images).
for i in range(len(users_directories)):
    basedir = 'C:/Users/helen/Downloads/Projeto.Iris/Projeto.Iris/Images/' + str(users_directories[i]) 
